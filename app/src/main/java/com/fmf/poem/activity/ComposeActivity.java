...
import com.fmf.poem.fragment.DatePickerFragment;
import com.fmf.poem.fragment.RhythmsDialogFragment;
import com.fmf.poem.model.Poem;
import com.fmf.poem.model.Rhythm;
import com.fmf.poem.poem.MetreFormater;
import com.fmf.poem.poem.PoemConstant;
import com.fmf.poem.util.DateUtil;
import com.fmf.poem.view.FloatLabelLayout;
...
//    private int day;
    ...
    private void bindRhythm(Rhythm rhythm) {
        if (rhythm != null) {
            ...
            if (PoemContract.TYPE_CI.equals(rhythm.getType())) {
...
//                break;
    ...
    private void draft() {
        savePoem(PoemContract.Poem.STATUS_DRAFT);
    }

    private void compose() {
        savePoem(PoemContract.Poem.STATUS_FINISHED);
    }
    ...
    private void savePoem(String status) {
        ...
        new AsyncTask<Void, Void, Integer>() {
            ...
            protected Integer doInBackground(Void... params) {
                ...
                if (result > 0) {
                    if (PoemContract.Poem.STATUS_DRAFT.equals(poem.getStatus())) {
                        tipId = R.string.tip_draft_success;
                    } else if (PoemContract.Poem.STATUS_FINISHED.equals(poem.getStatus())) {
