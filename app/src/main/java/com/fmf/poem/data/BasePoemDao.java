...
import com.fmf.poem.model.Model;
 ...
 */
public abstract class BasePoemDao<T extends Model> implements PoemSqlExpr {
    protected PoemDbHelper dbHelper;

    public PoemDbHelper getDbHelper() {
        return dbHelper;
    }

    public void setDbHelper(PoemDbHelper dbHelper) {
        this.dbHelper = dbHelper;
    }

    public BasePoemDao(Context context) {
        this.dbHelper = new PoemDbHelper(context);
    }
